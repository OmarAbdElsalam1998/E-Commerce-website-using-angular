...
export class SearchComponent implements OnInit {
  ...
  addToCart(ProductId:any){
    ...
    //             this.CartItemsOfCurrentCustomer?.cartItem.splice(indexOfCurrentProduct,1);
    //             var arr:Cart[]=[...this.CartItemsOfCurrentCustomer?.cartItem];
    //             var cart=new Cart(item.productId,item.title,item.price,item.discount,item.thumbnail,item.count+1);
    //             arr.push(cart);
    //             var customerCart=new CustomerCart(this.currentCustomerId,arr);
    //             this.cart.UpdateCartForSpecificCustomer(this.CartItemsOfCurrentCustomer.id,customerCart);
    //           }
    //      }
    //      else{
    //       var arrrr:Cart[]=[];
    ...
    //         var customerCart=new CustomerCart(this.currentCustomerId,arrrr);
    //         console.log(customerCart);
    //         console.log(arrrr);
    ...
    //   }
    //   //if there isno items in localStorage
    //     else{
    ...
    // }     
        ...
        // this.cart.getProductById(ProductId).subscribe(res=>{
        //   this.cartItem=res;
        //   console.log(res);
  ...
  sort(event: any) {
    ...
    switch (event.target.value) {
      case "LowPrice":
        {
           console.log(this.productsList.sort((a:any, b:any) => parseFloat(a.price) - parseFloat(b.price)));
      ...
      case "HighPrice":
        {
             console.log(this.productsList.sort((a:any, b:any) => parseFloat(b.price) - parseFloat(a.price)));
        ...
        case "LowRate":
          {
             console.log(this.productsList.sort((a:any, b:any) => parseFloat(a.rating) - parseFloat(b.rating)));
        ...
        case "HighRate":
          {
               console.log(this.productsList.sort((a:any, b:any) => parseFloat(b.rating) - parseFloat(a.rating)));
              // this.productList?.products.sort((a:any, b:any) => parseFloat(b.price) - parseFloat(a.price));
